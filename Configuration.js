...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  endpoints.addEndpoint("1", "mA sensor", endpointType.weightSensor);
  //endpoints.addEndpoint("2", "", endpointType.ppmConcentrationSensor, ppmConcentrationSensorSubType.carbonDioxide);
}
